...
public class EntityCompactedSand extends EntityFallingSand {
	public int fuse;
	public int blockID;
	public EntityCompactedSand(World world) {
		super(world);
		this.fuse = 0;
	...
	public EntityCompactedSand(World world, double d, double d1, double d2, int i) {
		this(world);
		this.setPos(d, d1, d2);
		this.blockID = CompactedBlocks.compactedSand.id;
	...
	public String getEntityTexture() {
		return "/assets/compactedstuff/block/PacketSand.png";
	}
